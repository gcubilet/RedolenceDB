...
const styles = {
  ...
  statValue: { fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 400, color: '#7F77DD', lineHeight: 1 },
  ...
  backBtn: { marginTop: 16, padding: '8px 20px', background: '#7F77DD', color: '#fff', border: 'none', borderRadius: 20, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
}
