...
const styles = {
  ...
  browseBtn: { padding: '9px 20px', background: '#7F77DD', color: '#FDF8F2', borderRadius: 24, fontSize: 13, fontWeight: 500, textDecoration: 'none', fontFamily: "'DM Sans', sans-serif", display: 'inline-block' },
  ...
  moveBtn: { padding: '7px 0', background: '#7F77DD', color: '#FDF8F2', border: 'none', borderRadius: 20, fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
